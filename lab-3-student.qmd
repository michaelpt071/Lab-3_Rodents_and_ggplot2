...
> There are 7 character variables: species_id, sex, day_of_week, plot_type, genus, species, taxa. There are 7 double variables: record_id, month, day, year, plot_id, hindfoot_length, weight. There is 1 date variable.
...
ggplot(data = surveys, 
       mapping = aes(x = weight, 
                     y = species)) +
  geom_density_ridges(bandwidth = 2.5,
                      fill = "steelblue4") +
  theme(legend.position = "none") +
  labs(x = "Weight (g)",
       y = "",
